...
Ammo silhouettes: source PNGs in `textures/weapon/`. Rebuild HUD textures with `python tools/_hud_ammo_gen.py` (paths in that script point at a local OpenMoHAA `main/`).
